...
rk4.sol = rk4.duffing(init_u, c(d, gamma, omega),h/100,max.t)
...
plot_draws = sapply(1:100, function(iii){
  t(kalman_1d_ivp(t        = xx,
                  odefn    = odefn,
                  init_u   = init_u,
                  cov_type = 'int_wiener',
                  obs_type = 'chkrebtii',
